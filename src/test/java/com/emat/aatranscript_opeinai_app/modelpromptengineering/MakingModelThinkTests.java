...
@SpringBootTest
public class MakingModelThinkTests extends BaseTest {
    String story = """
    ...
    String prompt4 = """
       You are an expert at solving reasoning problems. A cup is an object with an open top and close on the sides and bottom. The open top does not prevent objects from passing through it. Pleas answer in the Polish language.
