...
@SpringBootTest
public class SummarizingPromptsTests extends BaseTest{
    ...
    String reviewPrompt = """
        ...
        Summarize the review below, delimited by triple backticks in two languages EN=english, PL=polish, in at most 30 words.
