...
@SpringBootTest
public class FewAndZeroShotTests extends BaseTest{
    ...
    void zeroShotPromptTestWithModelOptions() {
        ...
        OpenAiChatOptions openAiChatOptions = new OpenAiChatOptions.Builder(openAiChatProperties.getOptions())
                .withTemperature(1.1f) //default is 0.7
    ...
    void testMathPromptFewShotTest() {
        ...
        OpenAiChatOptions openAiChatOptions_open4 = OpenAiChatOptions.builder().withModel(OpenAiApi.ChatModel.GPT_4.value).build();
        ...
        Prompt prompt4 = new Prompt(promptTemplate.createMessage(), openAiChatOptions_open4);

        System.out.println("ChatGPT3 result");
        Generation result = openAiChatClient.call(prompt3).getResult();
        System.out.println(result.getOutput().getContent());
        System.out.println("ChatGPT4 result");
        Generation result4 = openAiChatClient.call(prompt4).getResult();
        System.out.printf(result4.getOutput().getContent());
