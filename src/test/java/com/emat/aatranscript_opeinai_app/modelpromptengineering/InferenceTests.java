...
@SpringBootTest
public class InferenceTests extends BaseTest {
    ...
    String emotionPrompt = """
            Identify a list of emotions that the writer of the following reviews is expressing, and provide a brief summary of each review. Write an answer in to languages EN-english, PL-polish
